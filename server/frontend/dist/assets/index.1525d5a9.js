...
`,J=({content:e,onClose:n})=>{var c,p;const[r,s]=d.exports.useState(localStorage.getItem("address")||""),o=d.exports.useContext(F),i=(c=o==null?void 0:o.addressesRef)!=null?c:null,l=g=>{s(g.target.value),localStorage.setItem("address",g.target.value)};return e=typeof e=="string"?e:e(r),u(we,{children:[t(be,{children:"\u4E0A\u4F20\u6210\u529F"}),i.current?u("div",{children:[u(z,{children:["\u8BF7 Windows \u7528\u6237\u5728\u9632\u706B\u5899\u5165\u7AD9\u89C4\u5219\u4E2D\u5F00\u901A ","9527"," \u7AEF\u53E3\uFF08",t("a",{href:"https://jingyan.baidu.com/article/09ea3ede7311dec0afde3977.html",target:"_blank",rel:"noreferrer",children:"\u6559\u7A0B"}),"\uFF09"]}),t(z,{children:u(ve,{children:[t(ye,{children:"\u8BF7\u9009\u62E9\u624B\u673A\u53EF\u4EE5\u8BBF\u95EE\u7684\u5C40\u57DF\u7F51IP"}),u("select",{value:r,onChange:l,children:[t("option",{value:"",disabled:!0,children:"- \u8BF7\u9009\u62E9 -"}),(p=i.current)==null?void 0:p.map(g=>t("option",{children:g},g))]})]})})]}):null,t(h,{children:e?t(me,{content:e}):null}),t(h,{children:e?t("a",{href:e,children:"\u8BF7 \u624B\u673A\u626B\u7801 \u6216 \u70B9\u51FB\u4E0B\u8F7D"}):null}),t(C,{}),t(h,{children:t(y,{onClick:n,children:"\u5173\u95ED"})})]})},Q=({context:e,content:n})=>{const r=L(t(J,{content:n,onClose:()=>r()}),{context:e})},$=({context:e,content:n})=>{const r=L(t(J,{content:n,onClose:()=>r()}),{context:e})},E=()=>L(t(P,{children:"\u4E0A\u4F20\u4E2D"})),we=a.div`
  padding: 16px;
`,_=(e,n)=>(T().then(r=>{r.send({clientId:m,type:n,url:e.data.url})}),e),Ce=e=>w.post("/api/v1/texts",{raw:e}).then(n=>_(n,"text")),H=e=>{const n=new FormData;return n.append("raw",e),w({method:"post",url:"/api/v1/files",data:n,headers:{"Content-Type":"multipart/form-data"}}).then(r=>_(r,"file"))},$e=()=>{const e=d.exports.useContext(F),[n,r]=d.exports.useState("");return u(R,{className:"uploadForm",onSubmit:async o=>{o.preventDefault(),E();const{data:{url:i}}=await Ce(n);Q({context:e,content:l=>l&&`http://${l}:9527/static/downloads?type=text&url=http://${l+":9527"+encodeURIComponent(i)}`})},children:[t("div",{className:"row",children:t(q,{value:n,onChange:o=>r(o.target.value)})}),t(h,{className:"row",children:t(y,{type:"submit",children:"\u4E0A\u4F20"})})]})},Ee=()=>{const e=d.exports.useContext(F),[n,r]=d.exports.useState("default");return t(R,{className:"uploadForm",children:t("div",{className:"row",children:u(Se,{onDrop:async c=>{var v,b,x;c.preventDefault();const p=(x=(b=(v=c.dataTransfer)==null?void 0:v.items)==null?void 0:b[0])==null?void 0:x.getAsFile();if(!p)return;const g=p.type||"unknown";E();const{data:{url:S}}=await H(p);$({context:e,content:D=>D&&`http://${D}:9527/static/downloads?type=${g}&url=${encodeURIComponent(`http://${D}:9527${S}`)}`})},onDragOver:c=>{c.preventDefault(),r("dragging")},onDragLeave:c=>{r("default")},className:n,children:[t(De,{type:"file",value:"",onChange:async c=>{var v,b;const p=(b=(v=c.target)==null?void 0:v.files)==null?void 0:b[0];if(!p)return;const g=p.type||"unknown";E();const{data:{url:S}}=await H(p);$({context:e,content:x=>x&&`http://${x}:9527/static/downloads?type=${g}&url=${encodeURIComponent(`http://${x}:9527${S}`)}`})}}),t("p",{children:"\u70B9\u51FB\u6253\u5F00\u6587\u4EF6 \u6216 \u62D6\u62FD\u6587\u4EF6\u81F3\u6B64"})]})})})},Se=a.div`
  &.dragging {
...
`,Te={borderColor:"#333",highlightColor:"#f5b70d"},Me=()=>{const e=d.exports.useRef(null),n={addressesRef:e};return d.exports.useEffect(async()=>{const{data:{addresses:r}}=await w.get("/api/v1/addresses").catch(s=>Promise.reject(s));e.current=oe.uniq(r==null?void 0:r.concat("127.0.0.1"))},[]),d.exports.useEffect(()=>{T().then(r=>{r.onMessage(s=>{const{url:o,type:i}=s;if(s.clientId!==m){const l=c=>c&&`http://${c}:9527/static/downloads?type=${i}&url=${encodeURIComponent(`http://${c}:9527${o}`)}`;i==="text"?Q({context:n,content:l}):$({context:n,content:l})}})})},[]),u(re,{theme:Te,children:[t(je,{}),t(F.Provider,{value:n,children:t(ie,{history:Y,children:u(O,{children:[t(se,{exact:!0,from:"/",to:"/message"}),t(f,{exact:!0,path:"/downloads",children:t(He,{})}),t(f,{path:"/",children:t(Le,{})}),t(f,{path:"*",children:t("div",{children:"404"})})]})})})]})};ne.render(t(U.StrictMode,{children:t(Me,{})}),document.getElementById("root"));
